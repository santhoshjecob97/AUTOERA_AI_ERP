...
import { ShieldCheck, ArrowLeft, Search, ClipboardList, ThumbsUp } from 'lucide-react';
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            <ShieldCheck className="text-orange-600" /> Quality & Customer Experience
          </h1>
          <p className="text-slate-500">Damage Detection, Quality Audits & Feedback Intelligence</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-100 p-6">
          ...
          <div className="h-64 bg-slate-50 rounded-lg flex items-center justify-center text-slate-400">
            Quality metrics and trends visualization
          </div>
        </div>
      </div>
