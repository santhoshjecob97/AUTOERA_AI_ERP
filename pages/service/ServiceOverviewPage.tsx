...
import {
    CheckCircle, Clock, User, Box, Plus, List, LayoutGrid, Car, Sparkles, ClipboardList
} from 'lucide-react'; // Reduced imports as layout handles others
...
// Copied data from ServiceEngine.tsx
        ...
        <div className="space-y-6">
            ...
            {isImportOpen && (
                <CsvImportModal
                    ...
                    mapRow={(raw) => {
                        return { ...raw }; // Simplified for now, real implementation would map fields if needed
                    }}
